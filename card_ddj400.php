    ...
    <section>
    	<div class="container">
            <div class="about_block animate__animated animate__fadeIn animate__delay-2s">
                <img src="../images/400.jpg" alt="" class="img_about">
                <div class="text_block">
                    <h1 class="text_about">Pioneer DDJ-400</h1>
                    <p class="subtext_about">Pioneer DDJ-400 - 2-канальный DJ-контроллер для rekordbox dj. Если вы желаете опробовать свои силы в диджеинге, ищете себе верного компаньона для домашних занятий и живых выступлений, новейший контроллер Pioneer DDJ-400 - это то, что вам нужно!</p><br>
                    <div class="cost_btn">
                    	<p class="cost">43 600 Р/шт</p>
