...
<head>
    ...
    <link rel="stylesheet" href="../css/market_vynil.css">
        ...
        <div class="container">
            <div class="about_block">
                <div class="text_block animate__animated animate__fadeInLeft animate__delay-1s">
                    <h1>Виниловые проигрыватели</h1>
                    <div class="products-wrapper">
                        <div class="product">
                                <img src="../images/vynil2.png" alt="" class="table_icon">
                        ...
                        <div class="product">
                            <img src="../images/vynil1.jpg" alt="" class="table_icon">
                                    <p>Technics SL-1210 MK7</p>
                                    <p1 class="p1">
                                        223 180 Р/шт
                        ...
                        <div class="product">
                                    <img src="../images/vynil.png" alt="" class="table_icon">
                                    <p>Technics SL-1210GR</p>
                                    <p1 class="p1">
                                        165 580 Р/шт
