    ...
    <section>
    	<div class="container">
            <div class="about_block animate__animated animate__fadeIn animate__delay-2s">
                <img src="../images/sb3.jpg" alt="" class="img_about">
                <div class="text_block">
                    <h1 class="text_about">Pioneer DDJ-SB3</h1>
                    <p class="subtext_about">Pioneer DDJ-SB3 - усовершенствованная версия известного контроллера DDJ-SB2, который заработал отличную репутацию среди огромного количества диджеев, и начинающих, и маститых профессионалов благодаря сочетанию профессиональных характеристик и простоты использования.</p><br>
                    <div class="cost_btn">
                    	<p class="cost">42 600 Р/шт</p>
