    ...
    <section>
        <div class="conteiner">
            <div class="about_block">
                <form action="../php/go.php" method="post" onsubmit="onSubmit()" class="box1 animate__animated animate__fadeIn animate__delay-2s">
                    <h1>Авторизация</h1>
                    <input class="but" name="userName" id="userName" type="text" placeholder="Имя пользователя">
                    <input class="but" name="userPassword" id="userPassword" type="password" placeholder="Пароль">
                    <input class="button" id="submit" name="submit" type="submit" value="Войти">
