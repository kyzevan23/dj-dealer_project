    ...
    <section class="about">
        <div class="conteiner">
            <div class="about_block">
                <form action="../php/check.php" method="post" class="box1 animate__animated animate__fadeIn animate__delay-2s">
                    <h1>Регистрация</h1>
                    <input class="but" id="userName" type="text" name="userName" placeholder="Имя пользователя">
                    <input class="but" id="userPassword" type="password" name="userPassword" placeholder="Пароль">
                    <input class="but" id="userEmail" type="text" name="userEmail" placeholder="Электронная почта">
