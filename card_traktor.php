    ...
    <section class="section">
    	<div class="container">
            <div class="about_block animate__animated animate__fadeIn animate__delay-2s">
                <img src="../images/s2.jpg" alt="" class="img_about">
                <div class="text_block">
                    <h1 class="text_about">Traktor Kontrol S2 MK3</h1>
                    <p class="subtext_about">Native Instruments Traktor Kontrol S2 MK3 - 2-канальный DJ-контроллер для диджеев. Новое поколение популярного контроллера обладает всеми необходимыми функциями для креативного диджеинга.</p><br>
                    <div class="cost_btn">
                    	<p class="cost">45 180 Р/шт</p>
