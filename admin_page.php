    ...
    <section class="about">
        <div class="conteiner">
            <div class="about_block">
                <form action="#" id="form" method="post" onsubmit="onCheckItem()" class="box1 animate__animated animate__fadeIn animate__delay-2s">
                    <h3>Добавить товар</h3>
                    <select name="devision" class="select" placeholder="Раздел товара">
                        <option value="1">CD / USB проигрыватели</option>
                        <option value="2">Наушники</option>
                        <option value="3">Виниловые проигрыватели</option>
                        <option value="4">DJ контроллеры</option>
                    </select>
                    <input class="but" name="item_name" id="item_name" type="text" placeholder="Название товара">
                    <input class="but" name="item_cost" id="item_cost" type="text" placeholder="Цена товара">
                    <div class="file">
                        <div class="file_item">
                    ...
                    <input class="button" id="submit" name="submit" type="submit" value="Добавить товар">
                </form>
            </div>
        </div>
    </section>
